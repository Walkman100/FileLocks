	...
	Class SystemHandles
		...
		Friend Shared Function GetHandleInfo(handle As SYSTEM_HANDLE, Optional getAllNames As Boolean = False, Optional onlyGetNameFor As SYSTEM_HANDLE_TYPE = SYSTEM_HANDLE_TYPE.UNKNOWN) As HandleInfo
			...
			Try
				...
				If handleInfo.TypeString IsNot Nothing AndAlso (onlyGetNameFor = SYSTEM_HANDLE_TYPE.UNKNOWN OrElse handleInfo.Type = onlyGetNameFor) AndAlso (getAllNames = True OrElse (Not (handleInfo.Type = SYSTEM_HANDLE_TYPE.FILE AndAlso handleInfo.GrantedAccess = &H120089 AndAlso handleInfo.Flags = SYSTEM_HANDLE_FLAGS.INHERIT) AndAlso Not (handleInfo.Type = SYSTEM_HANDLE_TYPE.FILE AndAlso handleInfo.GrantedAccess = &H120189 AndAlso handleInfo.Flags = &H0) AndAlso Not (handleInfo.Type = SYSTEM_HANDLE_TYPE.FILE AndAlso handleInfo.GrantedAccess = &H120189 AndAlso handleInfo.Flags = SYSTEM_HANDLE_FLAGS.INHERIT) AndAlso Not (handleInfo.Type = SYSTEM_HANDLE_TYPE.FILE AndAlso handleInfo.GrantedAccess = &H12019f AndAlso handleInfo.Flags = &H0) AndAlso Not (handleInfo.Type = SYSTEM_HANDLE_TYPE.FILE AndAlso handleInfo.GrantedAccess = &H12019f AndAlso handleInfo.Flags = SYSTEM_HANDLE_FLAGS.INHERIT) AndAlso Not (handleInfo.Type = SYSTEM_HANDLE_TYPE.FILE AndAlso handleInfo.GrantedAccess = &H1a019f AndAlso handleInfo.Flags = &H0) AndAlso Not (handleInfo.Type = SYSTEM_HANDLE_TYPE.FILE AndAlso handleInfo.GrantedAccess = &H1a019f AndAlso handleInfo.Flags = SYSTEM_HANDLE_FLAGS.INHERIT))) Then
